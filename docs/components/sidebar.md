<script setup>
import DdtwSidebarExample from './sidebar/examples/DdtwSidebarExample.vue'
import DdtwSidebarDropdownExample from './sidebar/examples/DdtwSidebarDropdownExample.vue'
import DdtwSidebarGroupExample from './sidebar/examples/DdtwSidebarGroupExample.vue'
import DdtwSidebarCtaExample from './sidebar/examples/DdtwSidebarCtaExample.vue'
import DdtwSidebarLogoExample from './sidebar/examples/DdtwSidebarLogoExample.vue'
</script>
...
<script setup>
import { DdtwSidebar, DdtwSidebarItem } from '@datadayrepos/ddtw-vue'
</script>
```

## Multi-level menu
Use this sidebar example to create multi-level menu items by using the DdtwSidebarDropdownItem component.

<DdtwSidebarDropdownExample />
...
<script setup>
import { DdtwSidebar, DdtwSidebarDropdownItem, DdtwSidebarItem } from '@datadayrepos/ddtw-vue'
</script>
```

## Content separator

<DdtwSidebarGroupExample />
...
<template>
  <DdtwSidebar>
    ...
    </DdtwSidebarItemGroup>
  </DdtwSidebar>
</template>

<script setup>
import { DdtwSidebar, DdtwSidebarItem, DdtwSidebarItemGroup } from '@datadayrepos/ddtw-vue'
</script>
```

## CTA button

<DdtwSidebarCtaExample />
...
<template>
  <DdtwSidebar>
    ...
    <DdtwSidebarCta v-if="isShowCta" label="Beta" @close="toggleCta">
...
<script setup>
import { DdtwSidebar, DdtwSidebarCta, DdtwSidebarItem } from '@datadayrepos/ddtw-vue'
</script>
```

## Logo branding

<DdtwSidebarLogoExample />

```vue
<template>
  <DdtwSidebar>
    <DdtwSidebarLogo name="Flowbite" logo="https://flowbite.com/docs/images/logo.svg" tag="router-link" />
    <DdtwSidebarItem>
      <template #icon>
        <svg
          class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
...
<script setup>
import { DdtwSidebar, DdtwSidebarItem, DdtwSidebarLogo } from '@datadayrepos/ddtw-vue'
</script>
```
