<script setup>
import DdtwFooterExample from './footer/examples/DdtwFooterExample.vue'
import DdtwFooterExampleSitemapLinks from './footer/examples/DdtwFooterExampleSitemapLinks.vue'
import DdtwFooterExampleSocialMediaIcons from './footer/examples/DdtwFooterExampleSocialMediaIcons.vue'
import DdtwFooterExampleSticky from './footer/examples/DdtwFooterExampleSticky.vue'
import DdtwFooterExampleWithLogo from './footer/examples/DdtwFooterExampleWithLogo.vue'
</script>
# Vue Footer - Flowbite
...
<template>
  <ddtw-footer>
    <ddtw-footer-copyright
      by="Flowbite™"
      href="https://flowbite.com/"
      copyright-message="All Rights Reserved."
    />
    <ddtw-footer-link-group>
      <ddtw-footer-link href="#">
        About
      </ddtw-footer-link>
      <ddtw-footer-link href="#">
        Privacy Policy
...
<ddtw-footer-example-with-logo />
```vue
<template>
  <ddtw-footer footer-type="logo">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      <div class="sm:flex sm:items-center sm:justify-between">
        <ddtw-footer-brand href="https://flowbite.com" src="https://flowbite.com/docs/images/logo.svg" alt="Flowbite Logo" name="Flowbite" />
        <ddtw-footer-link-group class="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
          <ddtw-footer-link href="/">
            About
          </ddtw-footer-link>
          <ddtw-footer-link href="/">
      ...
      <ddtw-footer-copyright href="/" by="Flowbite™" />
    </div>
  </ddtw-footer>
</template>
...
<ddtw-footer-example-social-media-icons />
```vue
<template>
  <ddtw-footer footer-type="socialmedia">
    <div class="md:flex md:justify-between">
      <ddtw-footer-brand alt="Flowbite Logo" href="https://flowbite.com" name="Flowbite" src="https://flowbite.com/docs/images/logo.svg" />
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
            Resources
          </h2>
          <ddtw-footer-link-group class="flex flex-col items-start">
            <ddtw-footer-link class="mb-4" href="/">
              Flowbite
            </ddtw-footer-link>
            <ddtw-footer-link class="mb-4" href="/">
              Tailwind CSS
    ...
    <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8">
    <div class="sm:flex sm:items-center sm:justify-between">
      <ddtw-footer-copyright by="Flowbite™" href="/" />
      <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
        <ddtw-footer-icon href="/">
...
<ddtw-footer-example-sitemap-links />
```vue
<template>
  <ddtw-footer footer-type="sitemap">
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
      <div>
        <h2 class="mb-6 text-sm font-semibold text-gray-400 uppercase">
          Company
        </h2>
        <ddtw-footer-link-group class="text-gray-300 flex flex-col items-start">
          <ddtw-footer-link class="mb-4" href="/">
            About
          </ddtw-footer-link>
          <ddtw-footer-link class="mb-4" href="/">
    ...
    <div class="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
      <ddtw-footer-copyright by="Flowbite™" class="text-sm text-gray-300 sm:text-center" href="/" />
      <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
        <ddtw-footer-icon href="/" sr-text="Facebook page">
