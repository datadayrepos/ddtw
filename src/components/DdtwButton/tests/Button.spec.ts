...
import DdtwButton from '../DdtwButton.vue'

describe('ddtwButton', () => {
  it('renders correct text', () => {
    const wrapper = mount(DdtwButton, { props: {}, slots: { default: 'test' } })
  ...
  it('provides correct classes for default color button', () => {
    ...
    const wrapper = mount(DdtwButton, { props: { color: 'default' } })
  ...
  it('provides correct classes for XL size', () => {
    ...
    const wrapper = mount(DdtwButton, { props: { size: 'xl' } })
    const classes = wrapper.classes()
