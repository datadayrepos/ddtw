...
import type { ButtonSize, ButtonVariant } from '../types' //  ButtonDuotoneGradient, ButtonGradient, ButtonMonochromeGradient,
...
const buttonColorClasses: ButtonClassMap<ButtonVariant> = {
  default: {
    ...
    complimentary: 'text-white bg-complimentary-700 focus:ring-4 focus:ring-complimentary-300 font-medium rounded-lg dark:bg-complimentary-600 focus:outline-none dark:focus:ring-complimentary-800',
    ...
    primary: 'text-white bg-primary-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg dark:bg-primary-600 focus:outline-none dark:focus:ring-primary-800',
  ...
  hover: {
    ...
    complimentary: 'hover:bg-complimentary-800 dark:hover:bg-complimentary-700',
    ...
    primary: 'hover:bg-primary-800 dark:hover:bg-primary-700',
...
const buttonOutlineColorClasses: ButtonClassMap<Exclude<ButtonVariant, 'light' | 'alternative'>> = {
  default: {
    ...
    complimentary: 'text-complimentary-700 border border-complimentary-700 focus:ring-4 focus:outline-none focus:ring-complimentary-300 font-medium rounded-lg text-sm text-center dark:border-complimentary-500 dark:text-complimentary-500 dark:focus:ring-complimentary-800',
    ...
    primary: 'text-primary-700 border border-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm text-center dark:border-primary-500 dark:text-primary-500 dark:focus:ring-primary-800',
    purple:
  ...
  hover: {
    ...
    complimentary: 'hover:text-white hover:bg-complimentary-800 dark:hover:text-white dark:hover:bg-complimentary-600',
    ...
    primary: 'hover:text-white hover:bg-primary-800 dark:hover:text-white dark:hover:bg-primary-600',
...
const buttonShadowClasses: Record<ButtonMonochromeGradient, string> = {
  ...
  complimentary: 'shadow-lg shadow-complimentary-500/50 dark:shadow-lg dark:shadow-complimentary-800/80',
}
*/
...
export function useButtonClasses(props: UseButtonClassesProps): { wrapperClasses: string, spanClasses: string } {
  ...
  //  const isGradient = !!props.gradient.value
    ...
    if (props.shadow.value === '') {
     ...
     if (typeof props.shadow.value === 'string') {
