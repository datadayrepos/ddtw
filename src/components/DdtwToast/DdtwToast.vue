<template>
  ...
  >
    <DdtwThemableChild
      ...
      class="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 rounded-lg" :class="[typeClasses]"
    >
      <slot
        v-if="$slots.icon"
...
import DdtwThemableChild from '/@/components/utils/DdtwThemable/DdtwThemableChild.vue'
